...
<body>
    ...
    <!-- Add the class 'right-panel-active' to show the sign-up form by default -->
        ...
        <div class="overlay-container" id="overlayCon">
            <div class="overlay">
                <div class="overlay-panel overlay-left">
                    ...
                    <button class="ghost" id="signIn" onclick="window.location.href='{% url 'home' %}'">Sign In</button>
                </div>
                <div class="overlay-panel overlay-right">
                    <h1>Hello, Friend!</h1>
                    <p>Enter your personal details and start your journey with us</p>
                    <button class="ghost" id="signUp" onclick="window.location.href='{% url 'home' %}'">Sign Up</button>
                </div>
            </div>
